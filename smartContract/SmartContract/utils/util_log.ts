...
export class logtools {
    ...
    static UpdateConfigFileName(hre: HardhatRuntimeEnvironment): void {
        logtools.configfile =  hre.network.name +"_deployresult" + ".json";
    ...
    static SetContract(name: string, deployer: string, addr: Address, abireadable: string[],funcreadable: string[], bytecode: string) {
        ...
        srcjson["contracts"][name] = { "deployer": deployer, "addr": addr, "abi": abireadable, "func": funcreadable};
